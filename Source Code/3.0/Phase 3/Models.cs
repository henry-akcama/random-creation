...
namespace RandomCreation
{
    ...
    public class CollectionViewModel : INotifyPropertyChanged
    {
        ...
        public CornerRadius RowCornerRadius => new CornerRadius(8);
    ...
    public class CategoryViewModel : INotifyPropertyChanged
    {
        ...
        public bool           IsSelected { get; }
        public bool           IsVisible  { get; }  // search filter — dims non-matching rows
        ...
        // Row opacity — faded when disabled or not matching search filter
        public double RowOpacity => (!Model.IsEnabled || !IsVisible) ? 0.35 : 1.0;
    ...
    public class CollectionManagementViewModel : INotifyPropertyChanged
    {
        ...
        public CollectionManagementViewModel(Collection model) => Model = model;
