...
namespace RandomCreation
{
    ...
    public static class ThemeService
    {
        ...
        public static void ApplyTheme(AppTheme theme)
        {
            ...
            // Update App.xaml-level brushes that can't be overridden by merged dicts.
            // These are used by DataTemplate triggers where DynamicResource from merged
            // dicts doesn't reliably update after a theme swap.
            var selColor = resolved == AppTheme.Light
                ? System.Windows.Media.Color.FromRgb(0xe0, 0xea, 0xf8)  // light blue
                : System.Windows.Media.Color.FromRgb(0x1e, 0x2a, 0x3a); // dark blue
            UpdateAppBrush("SelectedCategoryBrush", selColor);
        }

        private static void UpdateAppBrush(string key, System.Windows.Media.Color color)
        {
